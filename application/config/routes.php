...
$route['api-categories']['GET'] = 'api/posts/categories';
$route['api-subcategories']['GET'] = 'api/posts/subcategories';
$route['api-subcategories/(:any)']['GET'] = 'api/posts/subcategories/$1';
